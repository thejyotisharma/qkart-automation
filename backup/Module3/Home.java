...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
          ...
          wait.until(ExpectedConditions.or(
            ...
            ExpectedConditions.visibilityOfElementLocated(By.className("MuiCardContent-root"))
         ));
    ...
    public Boolean addProductToCart(String productName) {
        try {
             ...
             */
            List<WebElement> results = driver.findElements(By.className("css-s18byi"));
            for (WebElement result : results) {
                String title = result.findElement(By.className("css-yg30e6")).getText();
                if (title.equalsIgnoreCase(productName)) {
                    result.findElement(By.className("card-button")).click();
                    return true;
                }
            }
